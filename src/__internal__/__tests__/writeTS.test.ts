...
`;
  ...
  it('should write ts file with object type & pattern', async () => {
    const INPUT_DIRECTORY_PATH = './src/__internal__/__tests__/__posts__';
...
export type FileType = {
  path: './src/__internal__/__tests__/__posts__/[id]/index.ts'
  params: {
    id: string
  }
}
`;
  ...
  it('should write ts file with object type & without pattern', async () => {
    const INPUT_DIRECTORY_PATH = './src/__internal__/__tests__/__posts__';
